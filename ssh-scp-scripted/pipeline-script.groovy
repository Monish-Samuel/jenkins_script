...
def execute(){
  ...
  env.buildNo= buildNumber
	...
	stage('Build and Deploy image'){
			sh "ssh -o StrictHostKeyChecking=no -i ${env.WORKSPACE}/india-server.pem ec2-user@ec2-13-232-137-52.ap-south-1.compute.amazonaws.com '[ -e flask-app ] && rmdir -- flask-app'"
